...
\\ + \beta_4 \text{CERB}_t + \sum_{p} \gamma_p \text{Province}_p + \varepsilon_{ipt}
$$
...
```
During the pre-treatment period (2007–2015), the expected baseline LIM-AT rate for children in two-parent families was 11.82%. Prior to the 2016 policy reform, there was a severe structural disparity; the expected LIM-AT rate for children in lone-parent families was 30.01% higher than that of two-parent families (p < 0.001). Following the implementation of the CCB in 2016, the baseline trend isolates a 3.46% decrease in the two-parent family rate.
